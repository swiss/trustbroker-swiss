...
import { ObEScrollMode, ObMasterLayoutConfig } from '@oblique/oblique';

import { Constant } from '../../shared/constants';

@Injectable()
export class MasterLayoutConfig extends ObMasterLayoutConfig {
	constructor() {
		super();
		...
		this.locale.locales = Constant.LanguageCodes.map(code => code.toString());
	}
}
