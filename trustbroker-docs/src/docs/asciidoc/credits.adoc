...
|zulu-openjdk-alpine
|GPL-2
|https://docs.azul.com/core/tpls/october-2025/zulu21_jdk_tpl.html
...
https://github.com/swiss/trustbroker.swiss/blob/main/LICENSE.txt[GNU AFFERO GENERAL PUBLIC LICENSE Version 3].

== Contributions

Input and contributions to the XTB projects are considered according to:

- https://github.com/swiss/doc.trustbroker.swiss/blob/main/Code-of-Conduct.md[Code of Conduct]
- https://github.com/swiss/doc.trustbroker.swiss/blob/main/Contribution.md[Contribution]
